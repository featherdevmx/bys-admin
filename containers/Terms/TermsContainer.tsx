...
import {Header, Body, Main, StyledBadge, IconButton} from './TermsContainer.styled';
import { EyeIcon } from '../../components/ui/EyeIcon';
import { EditIcon} from '../../components/ui/EditIcon';

export const TermsContainers: FC= () => {

  const [lastVersion, setLastVersion] = useState<string>('12-12-2022 20:09:23');
  ...
  return (
    <Main>
      <Header>
        <Text color="black" h5>
          Última Actualización: <Text color="gray" h5>{lastVersion}</Text>
        </Text>
